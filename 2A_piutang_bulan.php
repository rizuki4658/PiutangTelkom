    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  	<div class="x_title">
                    	<h2><i class="fa fa-credit-card"></i><small>LAPORAN PIUTANG PER BULAN</small></h2>
                    ...
                    <div class="clearfix"></div>
                 	...
                 	<div class="x_content">
                 	<form class="form-horizontal form-label-left" action="./3_laporan_piutang/bulan.php" method="post">
