    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  	<div class="x_title">
                    	<h2><i class="fa fa-book"></i><small>LAPORAN JURNAL PER BULAN</small></h2>
                    ...
                    <div class="clearfix"></div>
                 	...
                 	<div class="x_content">
                 	<form class="form-horizontal form-label-left" action="./4_laporan_jurnal/bulan.php" method="post">
