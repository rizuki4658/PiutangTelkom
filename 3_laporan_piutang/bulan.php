              ...
              <div class="modal-content" style="margin-top: 20%;">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel2">
                      <i class="fa fa-credit-card"></i> <small>LAPORAN PIUTANG PER BULAN</small>
                    </h4>
                  </div>
                  <div class="modal-body">
                    <center><i class="glyphicon glyphicon-remove-circle" style="font-size: 50px;"></i></center>
                    <br>
                    <center>Data Piutang Bulan <?php echo $nama_bulan; ?> Tahun <?php echo $tahun; ?> tidak ditemukan</center>                 
                  </div>
                  <div class="modal-footer">
                    <a href="../2A_piutang_bulan.php" class="btn btn-round btn-default" style="height: 35px;">OK</a>                 
                  </div>
              </div>
            </div>
          </div>
...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $this->SetX(10);
        $this->Cell(35,0,"Bulan ".$nama_bulan." ".$tahun,0,0,'L');
        $this->SetX(233);
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Piutang '.date('d-m-Y',strtotime($tanggal_awal))." s/d ".date('d-m-Y',strtotime($tanggal_akhir)).'('.$nama_bulan.' '.$tahun.')');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
