...
if(!isset($_SESSION['username']) && !isset($_SESSION['password'])){ //cek apakah user sudah login
    ...
    $query_agen="SELECT * FROM piutang WHERE nama='$nama' AND user_npc='$user' AND pswd='$pswd'";
              ...
              <div class="modal-content" style="margin-top: 20%;">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel2">
                      <i class="fa fa-credit-card"></i> <small>LAPORAN PIUTANG</small>
                    </h4>
                  </div>
                  <div class="modal-body">
                    <center><i class="glyphicon glyphicon-remove-circle" style="font-size: 50px;"></i></center>
                    <br>
                    <center>Data Piutang tidak ditemukan</center>                 
                  </div>
...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $this->SetX(10);
        $this->Cell(35,0,"Keseluruhan",0,0,'L');
        $this->SetX(233);
        ...
        $query="SELECT * from piutang WHERE nama='$nama' AND user_npc='$user' AND pswd='$pswd' ORDER BY tgl ASC";
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Piutang Keseluruhan');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
