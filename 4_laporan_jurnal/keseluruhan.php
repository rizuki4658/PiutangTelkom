              ...
              <div class="modal-content" style="margin-top: 20%;">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel2">
                      <i class="fa fa-book"></i> <small>LAPORAN JURNAL</small>
                    </h4>
                  </div>
...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $query="SELECT * from jurnal ORDER BY tgl ASC";
        $hasil=mysqli_query($link,$query);

        $query_detail="SELECT * from detail_piutang WHERE status != 'Lunas(Thn. Pertama)' ORDER BY tgl ASC";
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Jurnal Keseluruhan');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
