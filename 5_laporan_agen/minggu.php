...
if(!isset($_SESSION['username']) && !isset($_SESSION['password'])){ //cek apakah user sudah login
    ...
    $query_agen="SELECT * FROM agen WHERE tgl >='$tanggal_awal' AND tgl <='$tanggal_akhir' ORDER BY tgl ASC";
              ...
              <div class="modal-content" style="margin-top: 20%;">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel2">
                      <i class="fa fa-users"></i> <small>LAPORAN AGEN PER MINGGU</small>
                    </h4>
                  </div>
                  <div class="modal-body">
                    ...
                    ?>
                    <center>Data Agen <?php echo $minggu; ?> Bulan <?php echo $nama_bulan; ?> Tahun <?php echo $tahun; ?> tidak ditemukan</center>                 
                  </div>
                  <div class="modal-footer">
                    <a href="../1A_agen_minggu.php" class="btn btn-round btn-default" style="height: 35px;">OK</a>                 
                  </div>
              </div>
            </div>
          </div>
...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $this->SetX(10);
        $this->Cell(35,0,$minggu." ".$nama_bulan." ".$tahun,0,0,'C');
        $this->SetX(233);
        ...
        $query="SELECT * from agen WHERE tgl >= '$tanggal_awal' AND tgl <= '$tanggal_akhir' ORDER BY tgl ASC";
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Agen '.date('d-m-Y',strtotime($tanggal_awal))." s/d ".date('d-m-Y',strtotime($tanggal_akhir)).'('.$minggu.' '.' '.$nama_bulan.' '.$tahun.')');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
