            ...
            <div class="modal-dialog modal-md">
              <div class="modal-content" style="margin-top: 20%;">
                  ...
                  <div class="modal-body">
                    ...
                    <br>
                    <center>Data detail piutang <?php echo "dengan SND(".$snd.") atas nama ".$cst." ".$nama_bulan." ".$tahun; ?> tidak ditemukan</center>                 
                  </div>
                  <div class="modal-footer">
                    <a href="../4A_detail_bulan.php" class="btn btn-round btn-default" style="height: 35px;">OK</a>                 
                  </div>
              </div>
            </div>
          </div>
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Piutang '.$cst.'('.$nama_bulan.' '.$tahun.')');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
